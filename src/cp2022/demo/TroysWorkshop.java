...
public class TroysWorkshop {
    ...
    private static class DiyFan implements Runnable {
        ...
        public DiyFan (Workshop workshop, List<TroysWorkplaceId> neededWorkplaces, int numIterations)
        {
    ...
    public static void main (String[] args)
    {
        ...
        // Create the DIY fans.
        Thread alice = new Thread(new DiyFan(workshop, Arrays.asList(new TroysWorkplaceId[]{machiningId, drillingId, paintingId}), 2), "Alice");
        Thread bob =
                new Thread(
                        new DiyFan(
                                workshop,
